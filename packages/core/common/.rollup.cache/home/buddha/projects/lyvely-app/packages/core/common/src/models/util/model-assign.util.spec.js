...
describe('model assign util', () => {
    describe('assignRawDataTo()', function () {
        ...
        it('assign array value', async () => {
            const obj = { arr: ['v1', 'v2'] };
            const result = assignRawDataTo({}, { arr: ['v1', 'v2'] });
        ...
        it('assign array value', async () => {
            ...
            const result = assignRawDataTo({}, obj);
            expect(result === null || result === void 0 ? void 0 : result.arr[0].field).toEqual('testValue');
