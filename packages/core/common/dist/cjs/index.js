...
function encodeHtml(str) {
    return heExports.encode(str);
}
function decodeHtml(str) {
    return heExports.decode(str);
}
function escapeHtml(str) {
    return heExports.escape(str);
}
function escapeHtmlIf(str, condition) {
    return condition ? heExports.escape(str) : str;
}
function unEscapeHtml(str) {
    return heExports.unescape(str);
}
...
function getValidationFields(model) {
    ...
    if (Array.isArray(model) || !((_a = model === null || model === void 0 ? void 0 : model.constructor) === null || _a === void 0 ? void 0 : _a.name))
        return new Set();
    const validationMetas = classValidator.getMetadataStorage().getTargetValidationMetadatas(model.constructor, model.constructor.name, true, false);
    return new Set((validationMetas === null || validationMetas === void 0 ? void 0 : validationMetas.map((meta) => meta.propertyName)) || []);
}
function isValidEmail(email) {
    return classValidator.isEmail(email);
}
...
const TransformObjectId = () => classTransformer.Transform(({ value, obj }) => (value && 'toString' in value ? value.toString() : value));
...
exports.UserAssignmentStrategy = void 0;
...
})(exports.UserAssignmentStrategy || (exports.UserAssignmentStrategy = {}));
...
function Match(property, validationOptions) {
    return (object, propertyName) => {
        classValidator.registerDecorator({
            ...
            validator: exports.MatchConstraint,
        });
    };
}
exports.MatchConstraint = class MatchConstraint {
    validate(value, args) {
...
exports.MatchConstraint = __decorate([
...
function NotMatch(property, validationOptions) {
    return (object, propertyName) => {
        classValidator.registerDecorator({
            ...
            options: validationOptions,
            constraints: [property],
            validator: exports.NotMatchConstraint,
        });
    };
}
exports.NotMatchConstraint = class NotMatchConstraint {
    validate(value, args) {
        const [relatedPropertyName] = args.constraints;
        const relatedValue = args.object[relatedPropertyName];
        return value !== relatedValue;
...
exports.NotMatchConstraint = __decorate([
    classValidator.ValidatorConstraint({ name: 'notMatch' })
], exports.NotMatchConstraint);
function Lte(property, validationOptions) {
    return (object, propertyName) => {
        classValidator.registerDecorator({
            ...
            options: validationOptions,
            constraints: [property],
            validator: exports.LteConstraint,
        });
    };
}
exports.LteConstraint = class LteConstraint {
    validate(value, args) {
        const [relatedPropertyName] = args.constraints;
        const relatedValue = args.object[relatedPropertyName];
...
exports.LteConstraint = __decorate([
    classValidator.ValidatorConstraint({ name: 'lte' })
], exports.LteConstraint);
function Gte(property, validationOptions) {
    return (object, propertyName) => {
        classValidator.registerDecorator({
            ...
            options: validationOptions,
            constraints: [property],
            validator: exports.GteConstraint,
        });
    };
}
exports.GteConstraint = class GteConstraint {
    validate(value, args) {
        const [relatedPropertyName] = args.constraints;
        const relatedValue = args.object[relatedPropertyName];
        if (relatedValue === null || relatedValue === undefined) {
...
exports.GteConstraint = __decorate([
    classValidator.ValidatorConstraint({ name: 'gte' })
], exports.GteConstraint);
...
function ObjectId(validationOptions) {
    return (object, propertyName) => {
        classValidator.registerDecorator({
            ...
            propertyName,
            options: validationOptions,
            validator: exports.ObjectIdConstraint,
        });
    };
}
exports.ObjectIdConstraint = class ObjectIdConstraint {
    validate(value) {
...
exports.ObjectIdConstraint = __decorate([
    classValidator.ValidatorConstraint({ name: 'ObjectId' })
], exports.ObjectIdConstraint);
...
class ModelValidator {
    ...
    async validate(options = {}) {
        ...
        this.setValidationErrors(await classValidator.validate(this.model, options));
...
function getPropertyConstraints(model, property) {
    var _a;
    return (((_a = classValidator.getMetadataStorage()
...
exports.FieldValidationErrorFlags = void 0;
(function (FieldValidationErrorFlags) {
    FieldValidationErrorFlags["Unique"] = "unique";
})(exports.FieldValidationErrorFlags || (exports.FieldValidationErrorFlags = {}));
...
const Headers = {
    ...
    X_CAPTCHA_ID: 'X-Captcha-Identity',
};

exports.UrlRoute = class UrlRoute {
};
exports.UrlRoute = __decorate([
...
const TransformTo = (type) => classTransformer.Type(() => type);
...
function implementsToJson(model) {
...
__decorate([
    classTransformer.Expose(),
    classTransformer.Transform(({ value, obj }) => { var _a; return ((_a = obj._id) === null || _a === void 0 ? void 0 : _a.toString()) || value; }),
...
exports.SortResult = class SortResult extends BaseModel {
};
__decorate([
    classTransformer.Expose(),
    __metadata("design:type", String)
], exports.SortResult.prototype, "id", void 0);
__decorate([
    classTransformer.Expose(),
    __metadata("design:type", Number)
], exports.SortResult.prototype, "sortOrder", void 0);
exports.SortResult = __decorate([
    classTransformer.Exclude()
], exports.SortResult);
exports.SortResponse = class SortResponse extends BaseModel {
};
__decorate([
    classTransformer.Type(() => exports.SortResult),
    PropertyType([exports.SortResult]),
    __metadata("design:type", Array)
], exports.SortResponse.prototype, "sort", void 0);
exports.SortResponse = __decorate([
    classTransformer.Expose()
], exports.SortResponse);
...
exports.OBJECT_ID_REGEX = OBJECT_ID_REGEX;
...
exports.implementsToJson = implementsToJson;
