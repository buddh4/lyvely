import { getMetadataStorage, isEmail, ValidatorConstraint, registerDecorator, validate } from 'class-validator';
...
const TransformObjectId = () => Transform(({ value, obj }) => (value && 'toString' in value ? value.toString() : value));
...
var FieldValidationErrorFlags;
(function (FieldValidationErrorFlags) {
    FieldValidationErrorFlags["Unique"] = "unique";
})(FieldValidationErrorFlags || (FieldValidationErrorFlags = {}));
...
const TransformTo = (type) => Type(() => type);
...
export { BaseModel, DocumentModel, EntityNotFoundException, FieldValidationErrorFlags, FieldValidationException, Filter, ForbiddenServiceException, Gte, GteConstraint, Headers, IntegrityException, Lte, LteConstraint, Match, MatchConstraint, MisconfigurationException, ModelValidationException, ModelValidator, NetworkException, NotMatch, NotMatchConstraint, OBJECT_ID_REGEX, ObjectId, ObjectIdConstraint, PropertyType, REGEX_HEX_COLOR, RateLimitException, ServiceException, SortResponse, SortResult, TransformObjectId, TransformTo, UnauthenticatedServiceException, UniqueConstraintException, UnsupportedOperationException, UrlRoute, UserAssignmentStrategy, applyValidationProperties, assignRawDataTo, assignRawDataToAndInitProps, chunkArray, createAndAssign, decodeHtml, encodeHtml, escapeHTML, escapeHtml, escapeHtmlIf, findByPath, getNumberEnumKeys, getNumberEnumValues, getPropertyConstraints, getPropertyTypeDefinition, getPropertyTypeDefinitions, getPrototypeTree, getQueuedPromise, getStringEnumKeys, getStringEnumValues, getValidationFields, implementsAfterInit, implementsGetDefaults, implementsToJson, initPropertyTypes, isGuid, isObjectId, isValidEmail, isValidObjectId, mapType, mergePercentages, noop, queuePromise, registerMapping, sortBySortOrder, unEscapeHtml, useSingleton, validateEmail };
