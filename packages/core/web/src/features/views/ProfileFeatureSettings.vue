...
import { getSettingFeaturesOfProfile } from '../helpers';
import { IFeature } from '@lyvely/core-interface';
import { cloneDeep } from 'lodash';
import { computed } from 'vue';
import FeatureSettingsTree from '@/features/components/FeatureSettingsTree.vue';
  ...
  <profile-settings>
    <ly-content-panel>
      <div class="">
        <div class="p-5">
          <ly-dimmed size="xs">
            Here you can enable or disable certain profile features. Note that in most cases
            disabling a feature will not remove any of the data related with a feature but rather
            hide features in menus and and other parts of the application. If disabling or enabling
            a certain feature has any side effects, you will be asked for confirmation.
          </ly-dimmed>
        </div>
        <FeatureSettingsTree :features="installableFeatures" />
      </div>
