...
import { useAccountCalendarPreferencesStore } from '@/user-accounts/stores/account-calendar-preferences.store';
...
const weekStrategy = [
  t('user-accounts.i18n.week-strategy.0'),
  t('user-accounts.i18n.week-strategy.1'),
  t('user-accounts.i18n.week-strategy.2'),
  t('user-accounts.i18n.week-strategy.3'),
  t('user-accounts.i18n.week-strategy.4'),
  t('user-accounts.i18n.week-strategy.5'),
  t('user-accounts.i18n.week-strategy.6'),
];
      ...
      <tr>
        <th class="p-3 text-left w-3/4">
          <div class="flex flex-col">
            <div>
              {{ t('user-accounts.i18n.year-start') }}
            </div>
            <ly-dimmed class="text-xs">
              {{ t('user-accounts.i18n.year-start-info') }}
            </ly-dimmed>
          </div>
        </th>
        <td class="bg-main p-3 text-left">
