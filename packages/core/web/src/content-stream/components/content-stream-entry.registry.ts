...
import {
  ...
  IContentTypeOptions,
} from '@/content-stream/interfaces/stream-entry-registration.interface';
import { IStreamEntryProps } from '@/content-stream/interfaces/stream-entry-props.interface';
import { IContentDetailsProps } from '@/content-stream/interfaces/content-details-props.interface';
import DefaultStreamEntry from '@/content-stream/components/DefaultStreamEntry.vue';
import {
