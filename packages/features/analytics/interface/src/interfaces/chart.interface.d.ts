...
export declare enum ChartAccumulation {
    Sum = "sum",
    Avg = "avg"
}
...
export declare enum ChartSeriesDataTypes {
    KEYVALUE = "KeyValue",
    ARRAY = "Array"
}
/**
 ...
 */
export type ChartSeriesKeyValueData<TValue = number> = ChartSeriesData<ChartSeriesDataTypes.KEYVALUE, Array<{
    key: string;
    value: TValue;
}>>;
/**
 ...
 * @template TValue The type of the series values (default: number)
 */
export type ChartSeriesKeyArrayData<TValue = number> = ChartSeriesData<ChartSeriesDataTypes.ARRAY, Array<TValue>>;
/**
 * Represents the types of accumulation for a chart series.
 *
 * @enum {string}
 */
export declare enum ChartSeriesAccumulation {
    Sum = "sum",
    Avg = "avg"
}
