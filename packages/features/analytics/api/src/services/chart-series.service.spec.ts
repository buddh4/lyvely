...
import { Profile, ProfileTestDataUtils, User } from '@lyvely/api';
import { Chart, ChartSeriesConfig, GraphChartConfig } from '../schemas';
import { CalendarInterval } from '@lyvely/dates';
import { CHART_SERIES_TYPE_SCORE } from '@lyvely/analytics-interface';
...
describe('ChartSeriesService', () => {
  ...
  describe('addSeries', () => {
    it('add score graph series', async () => {
      ...
      await chartSeriesService.addSeries(context, chart, {
