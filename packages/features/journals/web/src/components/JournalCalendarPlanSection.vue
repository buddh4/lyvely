...
import CalendarPlanSection from '@/calendar-plan/components/CalendarPlanSection.vue';
...
import JournalCalendarPlanItem from '@/journals/components/JournalCalendarPlanItem.vue';
