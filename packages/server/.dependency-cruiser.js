...
function createModuleDeps(name, allowedDeps) {
...
module.exports = {
  forbidden: [
    ...
    createModuleDeps('activities', extendDefaults(
      MODULE_POLICIES,
      MODULE_CONTENT,
      MODULE_USERS,
      MODULE_PROFILES,
      MODULE_TAGS,
      MODULE_TIME_SERIES)),
    createModuleDeps('auth', extendDefaults(MODULE_USERS)),
    createModuleDeps('calendar', extendDefaults()),
    createModuleDeps('content', extendDefaults(
      MODULE_PROFILES,
      MODULE_USERS,
      MODULE_POLICIES,
      MODULE_TAGS)),
    createModuleDeps('core', extendDefaults()),
    createModuleDeps('mails', extendDefaults()),
    createModuleDeps('permissions', extendDefaults()),
    createModuleDeps('policies', extendDefaults()),
    createModuleDeps('profiles', extendDefaults(
      MODULE_USERS,
      MODULE_PERMISSIONS,
      MODULE_MAILS,
      MODULE_POLICIES,
      MODULE_CALENDAR,
      MODULE_TAGS)),
    createModuleDeps('register', extendDefaults(
      MODULE_USERS,
      MODULE_PROFILES,
      MODULE_MAILS
    )),
    createModuleDeps('statistics', extendDefaults(
      MODULE_USERS,
      MODULE_ACTIVITIES // TODO: reverse this dependency...
    )),
    createModuleDeps('tags', extendDefaults(
      MODULE_PROFILES,
      MODULE_POLICIES
    )),
    createModuleDeps('test', extendDefaults(
      MODULE_USERS,
      MODULE_PROFILES,
      MODULE_POLICIES,
      MODULE_MAILS,
    ...
    createModuleDeps('time-series', extendDefaults(
      MODULE_CONTENT,
      MODULE_USERS,
      MODULE_PROFILES
    )),
    createModuleDeps('user-invites', extendDefaults(
      MODULE_USERS,
      MODULE_PROFILES,
      MODULE_POLICIES,
      MODULE_MAILS,
    )),
    createModuleDeps('user-permissions', extendDefaults(
      MODULE_USERS,
      MODULE_PERMISSIONS
    )),
    createModuleDeps('users', extendDefaults(MODULE_POLICIES)),
