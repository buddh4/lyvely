...
describe('ProfileScore', () => {
  ...
  beforeEach(async () => {
    ...
    TestProfileScoreModel = testingModule.get<Model<TestProfileScoreDocument>>('TestProfileScoreModel')
  ...
  describe('constructor', () => {
    ...
    it('Overwrite createdBy', async () => {
      ...
      const model = new TestProfileScore({ user, profile, score: 5, userStrategy: UserAssignmentStrategy.Shared }, { createdBy });
