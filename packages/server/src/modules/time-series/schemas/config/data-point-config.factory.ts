...
import { assignEntityData } from "@server/modules/core";
...
export interface DataPointStrategyType<T extends DataPointConfig> extends Function {
  new (settings?: any): T;
}

export function registerDataPointStrategy<TClass extends DataPointConfig>(strategy: StrategyId, type: DataPointStrategyType<TClass>) {
