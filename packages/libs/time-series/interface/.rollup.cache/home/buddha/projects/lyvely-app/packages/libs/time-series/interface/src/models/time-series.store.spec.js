...
import { DataPointValueType, NumberDataPointModel, TextDataPointModel, TimeSeriesContentModel, } from '../index';
    ...
    describe('createDataPoint', () => {
        it('number data point', () => {
            ...
            const model = new TimeSeriesContentModel({
                ...
                type: 'test',
                config: {
                    timeSeries: { interval, valueType: DataPointValueType.Number },
                },
            });
        ...
        it('text data point', () => {
            ...
            const model = new TimeSeriesContentModel({
                ...
                type: 'test',
                config: {
                    timeSeries: { interval, valueType: DataPointValueType.Text },
                },
            });
            const tid = toTimingId(new Date(), interval);
            const dataPoint = store.createDataPoint(model, tid);
