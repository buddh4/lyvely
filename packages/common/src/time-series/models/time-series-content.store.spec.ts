import { TimeSeriesDataPointStore } from './time-series-content.store';
import {
  DataPointValueType,
  IDataPointConfig,
...
import { toTimingId } from '@/calendar';
import { IContentMetadata } from '@/content';

describe('TimeSeriesDataPointStore', () => {
  describe('createDataPoint', () => {
    it('number data point', () => {
      const store = new TimeSeriesDataPointStore();
      const interval = CalendarIntervalEnum.Daily;
