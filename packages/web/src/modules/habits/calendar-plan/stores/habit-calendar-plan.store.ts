...
import { useHabitsService } from '@/modules/habits/common/services/habits.service';
...
export const useHabitCalendarPlanStore = defineStore('habitCalendarPlan', () => {
  ...
  const habitPlan = useCalendarPlan<HabitModel, HabitFilter>({
    filter: new HabitFilter(),
    cache: new TimeSeriesDataPointStore<HabitModel>(),
  ...
  function getHabits(interval: CalendarIntervalEnum) {
